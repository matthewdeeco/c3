(function (window) {
    ...
    c3_chart_internal_fn.initParams = function () {
        ...
        $$.rotated_padding_left = config.subchart_rotated_padding_left;;
        $$.rotated_padding_right = config.axis_rotated && !config.axis_x_show ? 0 : config.subchart_rotated_padding_right;;
    ...
    c3_chart_internal_fn.updateSizes = function () {
        ...
        $$.margin = config.axis_rotated ? {
            ...
            left: $$.rotated_padding_right + subchartHeight + (hasArc ? 0 : $$.getCurrentPaddingLeft())
        } : {
    ...
    c3_chart_internal_fn.getDefaultConfig = function () {
        var config = {
            ...
            subchart_rotated_padding_right: 100,
            subchart_rotated_padding_left: 30,
            ...
            g.each(function () {
                ...
                function splitTickText(d, maxWidth) {
                    ...
                    if (!maxWidth || maxWidth <= 0) {
                        maxWidth = isVertical ? 230 : params.isCategory ? (Math.ceil(scale1(ticks[1]) - scale1(ticks[0])) - 12) : 110;
                    }
